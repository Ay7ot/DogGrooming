...
export function MainAbout(){
    ...
    return (
        <section className="text-center mt-[100px] px-10 pb-10 flex flex-col items-center">
            <h2 className="font-semibold text-[1.5rem] tracking-wider">DISCLAIMERS</h2>
            <ol className="list-none max-w-[600px] font-dai font-semibold pb-20 border-b-[1px] mt-6 flex flex-col gap-4">
            ...
            <div className="max-w-[700px] mt-10 flex flex-col gap-6 md:grid md:grid-cols-3">
                <div>
                    <h3 className="font-dai font-semibold text-[1.2rem]">CONTACT</h3>
                ...
                <div>
                    <h3 className="font-dai font-semibold">HOURS</h3>
                    <div className="flex flex-col gap-3 mt-3">
                ...
                <div>
                    <h3 className="font-dai font-semibold">LOCATION</h3>
            ...
            <div className="flex flex-col gap-3 mt-10 pb-20 border-b-[1px]">
                <p className="font-semibold text-[#808080] font-dai">PET DROP-OFF FOR GROOMING IS ANYTIME PRIOR TO OR AT YOUR APPOINTMENT TIME</p>
                <p className="font-semibold text-[#808080] font-dai">PETS BEING GROOMED MUST BE PICKED UP PRIOR TO 5 PM</p>
                <p className="font-semibold text-[#808080] font-dai">PLEASE ADD THE NAME AND BREED OF YOUR PET AT BOOKING</p>
            </div>
            <p className="py-10 max-w-[600px] md:px-10 text-[#808080] font-dai border-b-[1px]">
